            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="mb-6">
                      ...
                      <div class="mb-4 bt-switch">
                        ...
                        <input
                          ...
                          data-target="dropzone-fichierFATCA"
                          <?php if($usEntity2 === 1){echo "checked"; }?>
                        />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-10">
                      <div class="card-body">
                        ...
                        <div id="dropzone-fichierFATCA" class="dropzone us_entity_data_id">
                          <div class="fallback">
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="mb-6">
                      ...
                      <div class="mb-4 bt-switch">
                        ...
                        <input
                          ...
                          id="giin_id"
                          name="giin_check"
                          data-target="giin_data_id"
                          <?php if($usEntity2 === 1){echo "checked"; }?>
                        />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-9 row" id="giin_data_id">
                    <div class="col-md-3">
                      <div class="mb-3">
                        <label> <br><br></label>
                        <label>GIIN : </label>
                  ...
                  <div class="col-md-9 row <?php if($usEntity2 === 1){echo "hidden-select"; }?>" id="giin_data_autres_id">
                    <div class="col-md-3">
                      <div class="mb-3">
                        <label> <br><br></label>
                        <label>Autres : </label>
